...
TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    'get_macro_context': '[Fetching] macroeconomic context',
    'get_sentiment_score': '[Scoring] market sentiment',
    'get_historical_context': '[Loading] historical market context',
    ...
    'fetch_and_cache_filing': '[Downloading] SEC filing',
    'load_project_document': '[Loading] project document',
    'grep_filing': '[Searching] document',
    'read_file_section': '[Reading] document section',
    'read_full_filing': '[Reading] full document',
    'follow_reference': '[Following] cross-reference',
}
...
TOOL_TO_PHASE: Dict[str, str] = {
    ...
    'get_macro_context': 'gathering_data',
    'get_historical_context': 'gathering_data',
    'get_sector_rotation': 'gathering_data',
    'get_sentiment_score': 'analyzing',
    ...
    'fetch_and_cache_filing': 'gathering_data',
    'load_project_document': 'gathering_data',
    'grep_filing': 'reviewing',
    'read_file_section': 'reviewing',
    'read_full_filing': 'reviewing',
    'follow_reference': 'reviewing',
}
